...
function render() {
    ...
    spreadsheet.style.gridTemplateColumns = Array(numColumns).fill(0).map(function (_) { return '200px'; }).join(' ');
    var html = Array(numColumns * numRows).fill(0).map(function (_, idx) { return "<input class=\"box a\" id=cell_" + idx + "></input>"; }).join('');
